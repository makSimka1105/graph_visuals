...
export function GraphLegend() {
  ...
  return (
    <div className="graph-legend flex min-w-0 flex-wrap gap-1 bg-zinc-900/90 backdrop-blur-sm border border-zinc-800 overflow-hidden rounded-lg px-4 py-2 shrink">
      {items.map((item) => (
